...
questionList =
    [ Question "My team can clearly articulate their goals"
        1
        AgileMindset
        (feedbackListFromStrings AgileMindset
    ...
    , Question "My team feels recognized for their accomplishments"
        1
        CoachingLeadership
        (feedbackListFromStrings CoachingLeadership
    ...
    , Question "My team is more efficient when I’m not there"
        -1
        CCCL
        (feedbackListFromStrings CollaborativeCulture
...
feedbackListFromStrings : PromptCategory -> List String -> List Feedback
feedbackListFromStrings promptCategory strings =
    List.map (\s -> Feedback s promptCategory) strings
