	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$svg$Svg$Attributes$viewBox('0 0 175 600'),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										author$project$GraphElements$bar(barheight.E * 100),
								...
								_List_fromArray(
									[
										author$project$GraphElements$bar(barheight.O * 100),
								...
								_List_fromArray(
									[
										author$project$GraphElements$bar(barheight.B * 100),
