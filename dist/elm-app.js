...
var author$project$Main$init = {
	q: A2(elm$core$List$map, author$project$Main$promptBuilder, author$project$Main$questionList),
	ag: _List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('pt-4 pb-4 pl-3 bg-dark text-light  ')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
