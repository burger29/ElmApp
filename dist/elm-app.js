...
var $author$project$Types$StronglyAgree = {$: 'StronglyAgree'};
var $author$project$Types$StronglyDisagree = {$: 'StronglyDisagree'};
var $author$project$Main$intToSelectedResponse = function (flag) {
	switch (flag) {
		case 1:
			return $elm$core$Maybe$Just($author$project$Types$StronglyAgree);
		case 2:
			return $elm$core$Maybe$Just($author$project$Types$Agree);
		case 3:
			return $elm$core$Maybe$Just($author$project$Types$Neutral);
		case 4:
			return $elm$core$Maybe$Just($author$project$Types$Disagree);
		case 5:
			return $elm$core$Maybe$Just($author$project$Types$StronglyDisagree);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
		...
		F2(
			function (index, _v0) {
				...
				return {
					...
					promptCategory: pc,
					question: s,
					responseOptions: _List_fromArray(
						[$author$project$Types$StronglyAgree, $author$project$Types$Agree, $author$project$Types$Neutral, $author$project$Types$Disagree, $author$project$Types$StronglyDisagree]),
					selectedResponse: $elm$core$Maybe$Nothing,
					variable: i
				};
			}),
		listQuestions);
...
var $author$project$Types$AgileMindset = {$: 'AgileMindset'};
var $author$project$Types$CCCL = {$: 'CCCL'};
var $author$project$Types$CoachingLeadership = {$: 'CoachingLeadership'};
var $author$project$Types$CollaborativeCulture = {$: 'CollaborativeCulture'};
...
var $author$project$Types$AnsweringQuestions = function (a) {
	return {$: 'AnsweringQuestions', a: a};
};
var $author$project$Types$ErrorState = {$: 'ErrorState'};
var $author$project$Types$FillingOutForm = {$: 'FillingOutForm'};
...
var $author$project$Main$filterOutUnanswered = function (prompt) {
	var _v0 = prompt.selectedResponse;
	if (_v0.$ === 'Just') {
...
var $author$project$Types$ShowingResults = {$: 'ShowingResults'};
var $author$project$Main$modelStateFromString = F2(
	function (prompts, maybeQuery) {
		if (maybeQuery.$ === 'Just') {
			var query = maybeQuery.a;
			return (query === 'success') ? $author$project$Types$ShowingResults : $author$project$Types$FillingOutForm;
		} else {
			var _v1 = $author$project$Main$nextUnansweredQuestion(prompts);
			if (_v1.$ === 'Just') {
				var prompt = _v1.a;
...
var $author$project$Main$modelStateQueryParser = function (prompts) {
	return A2(
		$elm$url$Url$Parser$Query$map,
		$author$project$Main$modelStateFromString(prompts),
		$elm$url$Url$Parser$Query$string('submit'));
};
...
var $author$project$Main$parseModelState = function (prompts) {
	return A2(
		$elm$url$Url$Parser$questionMark,
		$elm$url$Url$Parser$s('rate-your-team'),
		$author$project$Main$modelStateQueryParser(prompts));
};
var $author$project$Main$selectState = F2(
	function (prompts, maybePageUrl) {
		...
		var maybeModelState = function () {
			if (maybePageUrl.$ === 'Just') {
				var url = maybePageUrl.a;
				return A2(
					$elm$url$Url$Parser$parse,
					$author$project$Main$parseModelState(prompts),
					url);
			} else {
				return $elm$core$Maybe$Just($author$project$Types$ErrorState);
			}
		}();
		return A2($elm$core$Maybe$withDefault, $author$project$Types$ErrorState, maybeModelState);
	});
...
var $author$project$Main$init = function (flags) {
	var savedResults = function () {
		...
		if (_v1.$ === 'Ok') {
			...
			return A4($author$project$Types$Results, 0, 0, 0, 0);
		}
	}();
	...
	var savedPrompts = A3(
		$elm$core$List$map2,
		F2(
			function (savedResponse, prompt) {
				return _Utils_update(
					prompt,
					{selectedResponse: savedResponse});
			}),
		savedResponses,
		prompts);
	var maybePageUrl = $elm$url$Url$fromString(flags.pageUrl);
	var emptyFormData = {formCompany: '', formEmail: '', formFirstName: '', formLastName: ''};
	return _Utils_Tuple2(
		{
			...
			state: A2($author$project$Main$selectState, savedPrompts, maybePageUrl)
		},
...
var $author$project$Main$checkToSubmit = function (input) {
	...
	var checkedFirstName = A2(
		$elm$core$List$cons,
		$author$project$Main$isFieldEmpty(input.formFirstName),
		listOfFields);
	var checkedLastName = A2(
		$elm$core$List$cons,
		$author$project$Main$isFieldEmpty(input.formLastName),
		checkedFirstName);
	var checkedEmail = A2(
		$elm$core$List$cons,
		$author$project$Main$isFieldEmpty(input.formEmail),
		checkedLastName);
	var checkedCompany = A2(
		$elm$core$List$cons,
		$author$project$Main$isFieldEmpty(input.formCompany),
		checkedEmail);
	return A2(
		$elm$core$List$all,
		function (item) {
...
var $author$project$Main$selectedResponseToInt = function (prompt) {
	var _v0 = prompt.selectedResponse;
	if (_v0.$ === 'Just') {
		var response = _v0.a;
		switch (response.$) {
		...
		switch (msg.$) {
			case 'SelectResponse':
				...
				var updatedPrompt = _Utils_update(
					prompt,
					{
						selectedResponse: $elm$core$Maybe$Just(response)
					});
				var currentResults = model.results;
				var updatedResults = function () {
					var _v1 = updatedPrompt.promptCategory;
					switch (_v1.$) {
						case 'SafetyCulture':
							return _Utils_update(
								currentResults,
								{
									sc: ($author$project$Main$selectedResponseOrZero(updatedPrompt.selectedResponse) * updatedPrompt.variable) + currentResults.sc
								});
						case 'AgileMindset':
							return _Utils_update(
								currentResults,
								{
									am: ($author$project$Main$selectedResponseOrZero(updatedPrompt.selectedResponse) * updatedPrompt.variable) + currentResults.am
								});
						case 'CoachingLeadership':
							return _Utils_update(
								currentResults,
								{
									cl: ($author$project$Main$selectedResponseOrZero(updatedPrompt.selectedResponse) * updatedPrompt.variable) + currentResults.cl
								});
						case 'CollaborativeCulture':
							return _Utils_update(
								currentResults,
								{
									cc: ($author$project$Main$selectedResponseOrZero(updatedPrompt.selectedResponse) * updatedPrompt.variable) + currentResults.cc
								});
						case 'SCCC':
							return _Utils_update(
								currentResults,
				...
				var beforeIndex = A2($elm$core$List$take, prompt.index, model.prompts);
				var afterIndex = A2($elm$core$List$drop, prompt.index + 1, model.prompts);
				...
				var updatedModel = _Utils_update(
					model,
					{
						...
						state: A2($author$project$Main$selectState, updatedPrompts, model.maybePageUrl)
					});
			...
			case 'ChangeModelState':
				var updatedModelState = _Utils_update(
					model,
					{state: $author$project$Types$ShowingResults});
				var conditional = model.allowSubmit;
			...
			case 'UpdateFormFirstName':
				...
				var updatedFormData = _Utils_update(
					formData,
					{formFirstName: updatedFirstname});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{allowSubmit: updatedAllowSubmit, formData: updatedFormData}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateFormLastName':
				var updatedLastname = msg.a;
				var formData = model.formData;
				var updatedAllowSubmit = $author$project$Main$checkToSubmit(formData);
				var updatedFormData = _Utils_update(
					formData,
					{formLastName: updatedLastname});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{allowSubmit: updatedAllowSubmit, formData: updatedFormData}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateFormEmail':
				var updatedEmail = msg.a;
				var formData = model.formData;
				var updatedAllowSubmit = $author$project$Main$checkToSubmit(formData);
				var updatedFormData = _Utils_update(
					formData,
					{formEmail: updatedEmail});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{allowSubmit: updatedAllowSubmit, formData: updatedFormData}),
...
var $author$project$Types$UpdateFormEmail = function (a) {
	return {$: 'UpdateFormEmail', a: a};
};
var $author$project$Types$UpdateFormFirstName = function (a) {
	return {$: 'UpdateFormFirstName', a: a};
};
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Insights on your team\'s ' + $author$project$Main$promptCategoryToString(pc))
					])),
				A2(
				$elm$html$Html$ul,
				_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Types$SelectResponse, response, prompt))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
...
var $author$project$Main$view = function (model) {
	...
	var formEmail = model.formData.formEmail;
	var formCompany = model.formData.formCompany;
	var _v0 = model.state;
	switch (_v0.$) {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('d-flex justify-content-center tracker')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('active-tracker')
											]),
										_List_fromArray(
											[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Take this 10-question quiz, created by ITIL® master Jo Peacock, and get personalized, actionable results.')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('pt-5 row justify-content-center')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('question-number pt-5')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(prompt.index + 1) + '.')
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(prompt.question)
									])),
								A2(
								$elm$html$Html$ul,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('list-group list-group-horizontal-sm response-list')
									]),
								A2(
									$elm$core$List$map,
									function (x) {
										return A3($author$project$Main$renderResponseList, x, prompt.selectedResponse, prompt);
									},
											...
											[
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Attributes$action('https://go.itpro.tv/l/425902/2020-02-06/8qzydq')
													]),
												_List_fromArray(
													[
														A2(
		...
		case 'ShowingResults':
			var exposeResults = model.results;
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('row mb-5  align-items-start d-flex')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class(' key-square-green')
															]),
														_List_Nil)
													])),
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('col-3 key-label')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('Efficient AND Effective')
													])),
												A2(
												$elm$html$Html$div,
												_List_fromArray(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('key-square-blue')
															]),
														_List_Nil)
													])),
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Efficient OR Effective')
													])),
												A2(
												$elm$html$Html$div,
												_List_fromArray(
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('key-square-orange')
															]),
														_List_Nil)
													])),
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Needs Improvement')
													]))
											]))
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('col-12 col-md-6 pb-5')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														...
														A2(
															...
															exposeResults.cl,
															_List_fromArray(
																['https://player.vimeo.com/video/363848139?api=1&player_id=vimeoplayer', 'https://player.vimeo.com/video/374492741?autoplay=0', 'https://player.vimeo.com/video/349665066?autoplay=0'])))
													]))
											])),
										A2(
										$elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Ready to upskill your team? Schedule a demo or buy now.')
											]))
									])),
								A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('col-12 d-flex justify-content-center')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('text-center btn btn-lg button-CTA'),
												...
												_List_fromArray(
													[
														$elm$html$Html$text('View Business Plans')
													]))
											]))
									]))
							]))
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('If you\'re seeing this, something has gone horribly wrong. Please try clearing your cache and refreshing.')
					]));
	}
};
					...
					return A2(
						...
						function (pageUrl) {
							return $elm$json$Json$Decode$succeed(
								{pageUrl: pageUrl, startingResults: startingResults, startingState: startingState});
						},
						A2($elm$json$Json$Decode$field, 'pageUrl', $elm$json$Json$Decode$string));
				},
